...
[AddComponentMenu("uScript/Graphs/Mission_DefeatEnemyAmbush")]
public class Mission_DefeatEnemyAmbush_Component : uScriptCode
{
	public Mission_DefeatEnemyAmbush ExposedVariables = new Mission_DefeatEnemyAmbush();
