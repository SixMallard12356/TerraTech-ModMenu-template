...
[AddComponentMenu("uScript/Graphs/Mission_DestroyTrees")]
public class Mission_DestroyTrees_Component : uScriptCode
{
	public Mission_DestroyTrees ExposedVariables = new Mission_DestroyTrees();
