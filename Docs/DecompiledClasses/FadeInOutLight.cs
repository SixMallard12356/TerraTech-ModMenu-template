...
public class FadeInOutLight : MonoBehaviour
{
	...
	[SerializeField]
	private bool FadeOutAfterCollision;

	[SerializeField]
	private bool UseHideStatus;
	...
	private void Start()
	{
		if (FadeOutAfterCollision || UseHideStatus)
		{
			d.LogWarning("FadeInOutLight - 'FadeOutAfterCollision' or 'UseHideStatus' is set, but Code for these behaviours is disabled due to performance cost!");
		}
