...
public class CFX_SpawnSystem : MonoBehaviour
{
	...
	public static GameObject GetNextObject(GameObject sourceObj, bool activateObject = true)
	{
		...
		{
			d.LogError("[CFX_SpawnSystem.GetNextPoolObject()] Object hasn't been preloaded: " + sourceObj.name + " (ID:" + instanceID + ")");
			return null;
		}
	...
	private void removeObjectsFromPool(GameObject sourceObject)
	{
		...
		if (!instantiatedObjects.ContainsKey(instanceID))
		{
			d.LogWarning("[CFX_SpawnSystem.removeObjectsFromPool()] There aren't any preloaded object for: " + sourceObject.name + " (ID:" + instanceID + ")");
			return;
		}
	...
	private void Awake()
	{
		if (instance != null)
		{
			d.LogWarning("CFX_SpawnSystem: There should only be one instance of CFX_SpawnSystem per Scene!");
		}
		instance = this;
	}
