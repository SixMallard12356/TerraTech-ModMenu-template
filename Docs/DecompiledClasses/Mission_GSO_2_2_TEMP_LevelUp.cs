...
[NodePath("Graphs")]
public class Mission_GSO_2_2_TEMP_LevelUp : uScriptLogic
{
	...
	private uScript_BlankNode logic_uScript_BlankNode_uScript_BlankNode_3 = new uScript_BlankNode();

	private bool logic_uScript_BlankNode_Out_3 = true;
	...
	{
		parentGameObject = g;
		logic_uScript_BlankNode_uScript_BlankNode_3.SetParent(g);
		owner_Connection_0 = parentGameObject;
	}
	...
	{
		logic_uScript_BlankNode_uScript_BlankNode_3.In();
	}
}
