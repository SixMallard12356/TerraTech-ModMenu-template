...
[NodePath("Graphs")]
public class EnableInvaders : uScriptLogic
{
	...
	private uScript_SetInvadersActive logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2 = new uScript_SetInvadersActive();

	private bool logic_uScript_SetInvadersActive_Out_2 = true;
	...
	{
		parentGameObject = g;
		logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2.SetParent(g);
	...
	private void Relay_Enable_2()
	{
		logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2.Enable();
		if (logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2.Out)
		{
			Relay_Succeed_5();
		}
	}

	private void Relay_Disable_2()
	{
		logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2.Disable();
		if (logic_uScript_SetInvadersActive_uScript_SetInvadersActive_2.Out)
		{
			Relay_Succeed_5();
		}
