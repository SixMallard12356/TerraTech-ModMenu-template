...
[AddComponentMenu("uScript/Graphs/Mission_DestroyRocks")]
public class Mission_DestroyRocks_Component : uScriptCode
{
	public Mission_DestroyRocks ExposedVariables = new Mission_DestroyRocks();
