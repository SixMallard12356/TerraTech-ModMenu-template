...
public struct HSBColor
{
	...
	public static void Test()
	{
		...
		d.Log("green: " + hSBColor);
		hSBColor = new HSBColor(Color.blue);
		d.Log("blue: " + hSBColor);
		hSBColor = new HSBColor(Color.grey);
		d.Log("grey: " + hSBColor);
		hSBColor = new HSBColor(Color.white);
		d.Log("white: " + hSBColor);
		hSBColor = new HSBColor(new Color(0.4f, 1f, 0.84f, 1f));
		d.Log("0.4, 1f, 0.84: " + hSBColor);
		d.Log("164,82,84   .... 0.643137f, 0.321568f, 0.329411f  :" + ToColor(new HSBColor(new Color(0.643137f, 0.321568f, 0.329411f))));
	}
}
